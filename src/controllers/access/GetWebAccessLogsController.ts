...
import { GetWebAccessLogsService, WebFilters } from "../../services/access/GetWebAccessLogsService";
...
export class GetWebAccessLogsController {
  async handle(req: FastifyRequest, rep: FastifyReply) {
    try {
      ...
      console.error("GetWebAccessLogsServiceError:", error);
      return rep.status(500).send({
        error: "ServiceError",
        message:
          "Opa, deu ruim na busca dos logs de acesso web! Tenta de novo ou fala com o suporte",
      });
    }
  }
}
