 ...
 * - v1.4.0 (2026-09-09): Declaração duplicada do request.user movida pro @types/fastify.d.ts
 */
...
// O tipo do request.user fica declarado em src/@types/fastify.d.ts.
// Antes ele era declarado aqui TAMBÉM, com um formato diferente do de lá,
// e as duas declarações se somavam de um jeito confuso.
