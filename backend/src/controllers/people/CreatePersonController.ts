...
export class CreatePersonController {
  ...
  async handle(req: FastifyRequest, rep: FastifyReply) {
    ...
    const { full_name, birth_date, cpf: rawCpf, email, phone, type, main_unit_type, unit_code } = req.body as any
  ...
  private validateBirthDate(birth_date: string | null, rep: FastifyReply): { valid: boolean; value: Date | null } {
