  ...
  private formatPersonDetails(
    ...
    return {
      ...
      employee: person.employee
        ...
        : null,
      // Se for visitante, pega os dados completos
      visitor: person.visitor
        ? {
            id: person.visitor.id,
            company: safeValue(person.visitor.company),
            visit_reason: safeValue(person.visitor.visit_reason),
            registration_date: safeDate(person.visitor.registration_date),
            visit_expiry_date: safeDate(person.visitor.visit_expiry_date),
